...
export const nonElementalItemCards: ActionCard[] = [
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Item - Battle Preps.webp',
    rarity: 'Uncommon',
  ...
  },
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Item - Graveyard Relic.webp',
    rarity: 'Rare',
    expansion: 'Fire and Water',
    subType: 'utility',
  ...
  },
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Item - Jamu Jahe Merah.webp',
    rarity: 'Common',
    expansion: 'Fire and Water',
    subType: 'healing',
  ...
  },
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Item - Kencur.webp',
    rarity: 'Common',
    expansion: 'Fire and Water',
    subType: 'healing',
    effectType: 'heal',
  ...
  },
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Item - Rec Scroll.webp',
    rarity: 'Uncommon',
    expansion: 'Fire and Water',
    subType: 'utility',
...
export const nonElementalSpellCards: ActionCard[] = [
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Spell - Prize.webp',
    rarity: 'Common',
    expansion: 'Fire and Water',
    subType: 'utility',
    effectType: 'draw',
  ...
  },
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Spell - Golden Crates.webp',
    rarity: 'Uncommon',
    expansion: 'Fire and Water',
    subType: 'utility',
    effectType: 'draw',
...
export const nonElementalQuickSpellCards: ActionCard[] = [
  {
    ...
    spektraCost: ['neutral', 'neutral'],
    description: 'Draw 1 card.',
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Spell - Crates.webp',
    rarity: 'Common',
    expansion: 'Fire and Water',
    subType: 'utility',
    effectType: 'draw',
...
export const nonElementalEquipmentCards: ActionCard[] = [
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Equipment - Energy Dagger.webp',
    rarity: 'Uncommon',
    expansion: 'Fire and Water',
    subType: 'equipment',
    cardNumber: 'GEN-097',
  ...
  },
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Equipment - Livin Dagger.webp',
    rarity: 'Common',
    expansion: 'Fire and Water',
    subType: 'equipment',
    cardNumber: 'GEN-098'
  },
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Equipment - Sacred Box.webp',
    rarity: 'Rare',
    expansion: 'Fire and Water',
    subType: 'equipment',
    cardNumber: 'GEN-099'
...
export const nonElementalFieldCards: FieldCard[] = [
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Field Spell - Haunted Stage.webp',
    rarity: 'Uncommon',
    expansion: 'Fire and Water',
    modifierType: 'skill_damage_boost',
    modifierValue: 1,
  ...
  },
  {
    ...
    art: '/attached_assets/card_images/GENESIS/neutral/Non Elemental For Apps_Field Spell - Sanggar.webp',
    rarity: 'Uncommon',
    expansion: 'Fire and Water',
    modifierType: 'skill_damage_boost',
    modifierValue: 2,
